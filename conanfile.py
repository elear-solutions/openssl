...
class OpenSSLConan(ConanFile):
    ...
    def build(self):
        if os.path.isfile("../libcrypto.so.1.0.0"):
    ...
    def _get_target(self):
        ...
        elif self.settings.os == "Linux" or self.settings.os == "Android":
    ...
    def unix_build(self):
        ...
        self.run_in_src("./Configure shared %s %s" % (target, self._get_flags()), win_bash=win_bash)
